...
import { Step } from "./modules/autenticacao/components/Step";
      ...
      <div className="flex flex-col bg-white shadow-md w-3/4 h-3/4  justify-start pt-4">
        ...
        <div className="flex justify-between px-4 pt-8">
          <div className="flex flex-col space-y-4 ">
            ...
            <TextInputWithIcon icon={<FaRegIdCard size={24} />} title="CPF"  input="cpf" register={register}/>
            <TextInputWithIcon icon={<MdOutlinePersonOutline size={26} />} title="Nome"  input="nome" register={register}/>
            <TextInputWithIcon icon={<MdOutlineMailOutline size={24} />} title="E-mail" input="email" register={register} />
            <TextInputWithIcon icon={<MdOutlinePhoneAndroid size={24} />} title="Celular"  input="celular" register={register}/>
          </div>
          <div className="flex flex-col space-y-4 ">
