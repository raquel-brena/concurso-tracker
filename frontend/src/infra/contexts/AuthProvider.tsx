...
import { registerRequest, signInRequest, verificarCadastro } from "../../modules/autenticacao/service/AuthService";
...
export default function AuthProvider({
    ...
    async function getUserByToken(token: string) {
        const response = await axios.get(`http://localhost:3000/api/usuario/token/${token}`, {
            headers: {
